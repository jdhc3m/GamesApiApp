package com.example.prigui.gamesapp.wrapper
...
class APIWrapper(context: Context, val API_KEY: String, version: Version = Version.PRO, val debug: Boolean = false) {
    ...
    fun getJSONArray(url: String, callback: OnSuccessCallback) {
        ...
        val request = object : JsonArrayRequest(completeURL, Response.Listener { response ->
